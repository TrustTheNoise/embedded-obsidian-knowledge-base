...
$$B u s_l o a d (%) 
= 
    frac(T_(b u s y), T_(o b s e r v e))$$
где:
- $T_(b u s y)$ - суммарное время передачи всех пакетов за интервал наблюдения
- $T_(o b s e r v e)$ - длительность интервала наблюдения
...
$$T_(f r a m e) 
= 
    frac("bits of frame", f_(C A N))
=
    frac(1 0 8, 5 0 0 0 0 0)
approx
    2 1 6 mu s$$
...
$$T_(f r a m e) = 2 1 6 mu s + 1.5 % = 2 1 9,2 4 mu s$$
...
$$T_(b u s y)="кол-во кадров" dot.op T_(f r a m e) = 2 0 0 0 dot.op 2 1 9,2 4 mu s = 4 3 8.5 m s$$
